...
const buttonStyle = {
  ...
  primary: {
    ...
    boxShadow: '0 2px 2px 0 rrgba(33, 33, 33, 1), 0 3px 1px -2px rgba(33, 33, 33, 1), 0 1px 5px 0 rgba(33, 33, 33, 0.1)',
    '&:hover': {
      backgroundColor: whiteBackground,
      boxShadow: '0 14px 26px -12px rgba(255, 255, 255, 1), 0 4px 23px 0px rgba(0, 0, 0, 0.12), 0 8px 10px -5px rgba(156, 39, 176, 0.2)',
    },
  },
  investorCard: {
